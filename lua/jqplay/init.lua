--true if jqplay session running, false otherwise
local is_running = false
--input buffer number (optional)
local in_buf = -1
--b:changedtick of input buffer (optional)
local in_changedtick = -1
--timer-ID of input buffer (optional)
local in_timer = 0
--filter buffer number
local filter_buf = 0
--b:changedtick of filter buffer
local filter_changedtick = 0
--timer-ID of filter buffer
local filter_timer = 0
--full path to filter file on disk
local filter_file = ""
--output buffer number
local out_buf = 0
--jq command running on buffer change
local jq_cmd = ""
--job object of jq process
local job_id = nil
